...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHolder>{
    private final List<ImageItem> listImages;
    private final Context context;
    private final DateGroupAdapter.OnImageClickListener imageClickListener;

    public ImageAdapter(Context context, List<ImageItem> listImages, DateGroupAdapter.OnImageClickListener imageClickListener){
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position){
        ImageItem imageItem = listImages.get(position);
            ...
            itemView.setOnClickListener(view -> {
                if(imageClickListener != null){
                    ...
                    if(position != RecyclerView.NO_POSITION){
                        imageClickListener.onImageClick(listImages.get(position).getImagePath());
                    }
                }
            });
        }
